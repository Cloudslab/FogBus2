...
sudo wg set wg0 peer NFFC0V+ZH/Q9FqV9/1ELfmZKluybv/0TaVBRijKaMXo= allowed-ips 10.0.0.1/32 endpoint 121.36.240.120:4500 persistent-keepalive 5

sudo wg set wg0 peer fAPjjeBrqAIAjKely/2bYY/THgT3nc0G5xlem42dPUY= allowed-ips 10.0.0.101/32 endpoint 124.71.175.60:4501 persistent-keepalive 5

sudo wg set wg0 peer PEcydD2LL48GHmHuH4eN6yU/W3kDFU+UTdB5VjTstE8= allowed-ips 10.0.0.102/32 endpoint 124.71.175.60:4502 persistent-keepalive 5

sudo wg set wg0 peer /ia/qcvq+LIP3AjjUv1Deeb+4JslXBOStVs3WDL2nRw= allowed-ips 10.0.0.103/32 endpoint 124.71.175.60:4503 persistent-keepalive 5

sudo wg set wg0 peer RlUr3SOmzYsAt/15BwVyC7J1PCqO6BKKWweC5penMUk= allowed-ips 10.0.0.104/32 endpoint 124.71.175.60:4504 persistent-keepalive 5
